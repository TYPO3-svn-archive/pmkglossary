 ...
 *
 *
 *   50: class tx_pmkglossary_wordtitle
 *   62:     function processDatamap_afterDatabaseOperations($status, $table, $id, &$fieldArray, &$reference)
 *   78:     function wordcharsOnly($text)
 *
 * TOTAL FUNCTIONS: 2
